...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if(isset($_SESSION['Pass'])){
            ...
            $applicant = new Applicant($_POST["Fullname"],$_POST["user_name"],$_POST["Address"],$_POST["email"],$_POST["Mobilenumber"],$_POST["gender"],$_POST["Birthday"],$_POST["password"]);
            $con->create_applicant_acc($_POST["user_name"],$_POST["email"],$_POST["password"],$applicant);
      }
}
?>
<!DOCTYPE html>
