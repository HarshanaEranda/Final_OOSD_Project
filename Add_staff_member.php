...
<head>
      ...
      <script>
            function ShowDetails(){
                  ...
                  var Divisional_Secretary=document.getElementById("Officer_D");
                  ...
                  if( Estate_Superintendent.checked){  
            ...
            else if (Divisional_Secretary.checked){ 
                  document.getElementById("DeatilsD").style.display="block";  
                  Officer_form.style.display="block";
            }
...
<body style="background-color:#9886e6fd;">
      <div style="padding: 100px;  background-color: #9886e6fd; font-weight: bolder;">
            <div><div><div>
                  ...
                  <form id="staff_entry_form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                        <fieldset id="Disable_Tag" >
                              <h2 style="color: black;  ">Select The Officer's Profession</h2>
                              <br>
                              <div class="mb-3 form-check">
                                    <input type="checkbox" class="form-check-input" name="officer" id="Officer_E" onclick="ShowDetails()">
                                    <label class="form-check-label" for="Officer_E">Estate Superintendent</label>
                              </div>
                              <div class="mb-3 form-check">
                                    <input type="checkbox" class="form-check-input" name="officer" id="Officer_D" onclick="ShowDetails()">
                                    <label class="form-check-label" for="Officer_D">Divisional Secretary</label>
                              </div> <div class="mb-3 form-check">
                                    <input type="checkbox" class="form-check-input" name="officer" id="Officer_G" onclick="ShowDetails()">
                                    <label class="form-check-label" for="Officer_G">Grama Niladari</label>
                              </div> <div class="mb-3 form-check">
                                    <input type="checkbox" class="form-check-input" name="officer" id="Officer_P" onclick="ShowDetails()">
                                    <label class="form-check-label" for="Officer_P">Principal</label>
                              </div>
                              <div class="mb-3 form-check">
                                    <input type="checkbox" class="form-check-input" name="officer" id="Officer_N" onclick="ShowDetails()">
                        ...
                        <fieldset id="Create_form" style="display: none;" >
                              <h2 style="color: black;  ">Create Officer Account</h2>
                              <br>
                              <div class="mb-3">
                                    <label for="exampleInputFname" class="form-label">Officer's Full Name</label>
                                    <input type="text" name="fname" class="form-control" id="exampleInputFname" aria-describedby="emailHelp" placeholder="Enter full name">
                              </div>
                              <div class="mb-3">
                            ...
                            <div class="mb-3">
                              <label for="exampleInputIDnumber" class="form-label">Staff Id Number</label>
                              <input type="text" name="staff_id" class="form-control" id="exampleInputIDnumber" aria-describedby="emailHelp" placeholder="Enter identticard number">
                        </div>
                        <div class="mb-3">
                              <label for="exampleInputMNumber" class="form-label">Mobile Number</label>
                              <input type="number" name="mob_no" class="form-control" id="exampleInputMNumber" placeholder="Enter mobile number">
                        </div></fieldset>
                        ...
                        <fieldset id="DeatilsP" style="display: none;">
                              <div class="mb-3" >
                                    <label for="exampleInputSchool" class="form-label">Current Working School Address</label>
                                    <input type="text" name="division" class="form-control" id="exampleInputSchool" placeholder="Enter current working school">
                              </div>
                        </fieldset>
                        <fieldset id="DeatilsG" style="display: none;">
                              <div class="mb-3" >
                                    <label for="exampleInputGDivision" class="form-label">Grama Niladari Division</label>
                                    <input type="text" name="division" class="form-control" id="exampleInputGDivision" placeholder="Enter current working grama niladari Division">
                              </div>
                        </fieldset>
                        <fieldset id="DeatilsD" style="display: none;">
                              <div class="mb-3" >
                                    <label for="exampleInputDSecretariat" class="form-label">Divisional Secretariat</label>
                                    <input type="text" name="division" class="form-control" id="exampleInputDSecretariat" placeholder="Enter current working Divisional secretariat">
                              </div>
                        </fieldset> 
                        <fieldset id="DeatilsN" style="display: none;">
                              ...
                              <div class="mb-3">
                                    <label for="exampleInputCNumber" class="form-label">Contact Number</label>
